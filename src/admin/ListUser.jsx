...
const UserList = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("http://34.101.102.183:3000/users"); // Sesuaikan dengan URL endpoint backend Anda
  ...
  const deleteUser = async (id_user) => {
    try {
      await axios.delete(`http://34.101.102.183:3000/users/${id_user}`); // Sesuaikan dengan URL endpoint untuk menghapus pengguna
