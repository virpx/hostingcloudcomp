...
export default function Editcourse() {
    ...
    async function editkursus(data) {
        if (data.thumbimg.length != 0) {
            ...
            var hasil = await axios.post("http://34.101.102.183:3000/teacher/updatekursuswithimage",formdata,{
                headers: {
            ...
            var hasil = await axios.post("http://34.101.102.183:3000/teacher/updatekursusnoimage",datapost,{
                headers: {
                    "x-auth-token": (JSON.parse(localStorage.getItem("user"))).token,
