...
export default function Coursecenter() {
  ...
  const urlapi = "http://34.101.102.183:3000/teacher/";
  ...
  const tanyaai = async ()=> {
    var topik = prompt("Topik soal")
    var jumlahsoal = prompt("Jumlah soal yang diinginkan")
    var namaquiz = prompt("Nama Quiz")
    const response = await axios.post(urlapi + "askgemini",{
      idkursus:dataload[1]["_id"],
      topik:topik,
      name:namaquiz,
