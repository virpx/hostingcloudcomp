...
const host = "http://34.101.102.183:3000";
      ...
      },
      {
        ...
        children: [
              ...
              },
              {
                ...
                loader: async (data) => {
                  var axiosget = await axios.get(
                    "http://34.101.102.183:3000/teacher/getcoursedetail/" +
                      data.params.id,
                    {
                      headers: {
                ...
                children: [
                  {
                    ...
                    loader: async (data) => {
                      var axiosget = await axios.get(
                        "http://34.101.102.183:3000/teacher/getcenter/" +
                          data.params.id,
                        {
                          headers: {
                  ...
                  },
                  {
                    ...
                    loader: async (data) => {
                      var hasil = await axios.get(
                        "http://34.101.102.183:3000/teacher/getquizdetail/" +
                          data.params.id +
                          "/" +
                          data.params.idquiz,
                        {
                  ...
                  },
                  {
                    ...
                    loader: async (data) => {
                      var hasil = await axios.get(
                        "http://34.101.102.183:3000/teacher/taskkumpul/" +
                          data.params.idtaske,
                        {
                          headers: {
                            "x-auth-token": JSON.parse(
                  ...
                  },
                  {
                    ...
                    loader: async (data) => {
                      var hasil = await axios.get(
                        "http://34.101.102.183:3000/teacher/gettopicdetail/" +
                          data.params.id +
                          "/" +
                          data.params.idtopic,
                        {
                  ...
                  },
                  {
                    ...
                    loader: async (data) => {
                      var hasil = await axios.get(
                        "http://34.101.102.183:3000/teacher/gettaskdetail/" +
                          data.params.id +
                          "/" +
                          data.params.idtask,
                        {
          ...
          },
          {
            ...
            loader: async () => {
              var hasil = await axios.get(
                "http://34.101.102.183:3000/teacher/reportdata",
                {
                  headers: {
                    "x-auth-token": JSON.parse(localStorage.getItem("user"))
                      .token,
            ...
            children: [
              {
                ...
                loader: async () => {
                  var hasil = await axios.get(
                    "http://34.101.102.183:3000/teacher/getchannel",
                    {
                      headers: {
                        "x-auth-token": JSON.parse(localStorage.getItem("user"))
                          .token,
              ...
              },
              {
                ...
                loader: async (data) => {
                  var hasil = await axios.get(
                    "http://34.101.102.183:3000/teacher/getforumdetail/" +
                      data.params.idforum,
                    {
                      headers: {
                        "x-auth-token": JSON.parse(localStorage.getItem("user"))
                  ...
                  for (const iterator of hasil.data.lanswer) {
                    const namauser = await axios.get(
                      "http://34.101.102.183:3000/teacher/getnamauser/" +
                        iterator.iduser
                    );
